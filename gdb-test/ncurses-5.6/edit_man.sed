...
s/TH \<can_change_color 3X ""/TH can_change_color 3NCURSES ""/
s/TH \<curs_attr_get 3X ""/TH attr_get 3NCURSES ""/
s/TH \<dup_field 3X ""/TH dup_field 3NCURSES ""/
s/TH \<init_pair 3X ""/TH init_pair 3NCURSES ""/
...
s/\<fBaddch\\fR(3X)/fBaddch\\fR(3NCURSES)/
s/\<fBcan_change_color\\fR(3X)/fBcan_change_color\\fR(3NCURSES)/
s/\<fBcurs_attr_get\\fR(3X)/fBattr_get\\fR(3NCURSES)/
s/\<fBdup_field\\fR(3X)/fBdup_field\\fR(3NCURSES)/
s/\<fBinit_pair\\fR(3X)/fBinit_pair\\fR(3NCURSES)/
...
s/^\\fBaddch\\f[RP] -/\\fBaddch\\fR -/
s/^\\fBcan_change_color\\f[RP] -/\\fBcan_change_color\\fR -/
s/^\\fBcurs_attr_get\\f[RP] -/\\fBattr_get\\fR -/
s/^\\fBdup_field\\f[RP] -/\\fBdup_field\\fR -/
s/^\\fBinit_pair\\f[RP] -/\\fBinit_pair\\fR -/
