...
extern bool call_can_change_color (void);
bool call_can_change_color (void)
{
...
extern bool call_has_colors (void);
bool call_has_colors (void)
{
	T((T_CALLED("has_colors()"))); returnBool(has_colors());
}


extern bool call_has_ic (void);
bool call_has_ic (void)
{
	T((T_CALLED("has_ic()"))); returnBool(has_ic());
}


extern bool call_has_il (void);
bool call_has_il (void)
{
...
extern bool call_isendwin (void);
bool call_isendwin (void)
{
	T((T_CALLED("isendwin()"))); returnBool(isendwin());
}


extern bool call_is_linetouched (WINDOW * a1, int z);
bool call_is_linetouched (WINDOW * a1, int z)
{
	T((T_CALLED("is_linetouched(%p,%d)"), a1, z)); returnBool(is_linetouched(a1, z));
}


extern bool call_is_wintouched (WINDOW * z);
bool call_is_wintouched (WINDOW * z)
{
...
extern char * call_tparm (char * a1, long a2, long a3, long a4, long a5, long a6, long a7, long a8, long a9, long z);
char * call_tparm (char * a1, long a2, long a3, long a4, long a5, long a6, long a7, long a8, long a9, long z)
{
	T((T_CALLED("(%s,%#lx,%#lx,%#lx,%#lx,%#lx,%#lx,%#lx,%#lx,%#lx)"), _nc_visbuf2(0,a1), (long)a2, (long)a3, (long)a4, (long)a5, (long)a6, (long)a7, (long)a8, (long)a9, (long)z)); returnPtr(tparm(a1, a2, a3, a4, a5, a6, a7, a8, a9, z));
}


extern char * call_tparm_varargs (char * a1, ...);
char * call_tparm_varargs (char * a1, ...)
{
	T((T_CALLED("(%s,%s)"), _nc_visbuf2(0,a1), "...")); returnPtr(tparm_varargs(a1));
}
...
extern bool call_mouse_trafo (int * a1, int * a2, _Bool z);
bool call_mouse_trafo (int * a1, int * a2, _Bool z)
{
